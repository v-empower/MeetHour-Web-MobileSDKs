...
dependency `go.meethour.io.react:meet-hour-sdk:5.0.14` into your `build.gradle` files.
...
dependencies {
    // (other dependencies)
    implementation ('go.meethour.io.react:meet-hour-sdk:5.0.14') { transitive = true }
}
```
