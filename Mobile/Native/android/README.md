...
dependency `go.meethour.io.react:meet-hour-sdk:5.0.12` into your `build.gradle` files.
...
dependencies {
    // (other dependencies)
    implementation ('go.meethour.io.react:meet-hour-sdk:5.0.12') { transitive = true }
}
```
