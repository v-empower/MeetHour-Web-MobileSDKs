/*
 * Copyright @ 2021-present Meet Hour, LLC
 *
...
- (void)processSampleBuffer:(CMSampleBufferRef)sampleBuffer withType:(RPSampleBufferType)sampleBufferType {
    ...
    NSLog(@"Buffer Type: %ld", (long)sampleBufferType);
...
- (NSString *)socketFilePath {
    ...
    NSString *appGroupIdentifier = @"group.go.meethour.io.ios.sdk.broadextension";
    ...
    NSLog(@"SocketConnection: ===>%@", socketFilePath);
...
- (void)openConnection {
  dispatch_queue_t queue = dispatch_queue_create("go.meethour.io.ios.sdk.connectTimer", 0);
