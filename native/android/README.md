...
dependency `go.meethour.io.react:meet-hour-sdk:3.2.0` into your `build.gradle` files.
...
dependencies {
    // (other dependencies)
    implementation ('go.meethour.io.react:meet-hour-sdk:3.2.0') { transitive = true }
}
```
