    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start"><a href="index.html">
                    <div class="flex flex-shrink-0 items-center"><img class="block h-8 w-auto lg:hidden" src="https://meethour.io/images/logo.SVG" alt="Your Company"><img class="hidden h-8 w-auto lg:block" src="https://meethour.io/images/logo.SVG" alt="Your Company"></div>
                </a>
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        <div class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page"><a href="/">Home</a></div>
                        ...
                        <div class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                            <a href="/join-meeting">Join Meeting</a>
                        </div>
                    </div>
                </div>
            </div>
