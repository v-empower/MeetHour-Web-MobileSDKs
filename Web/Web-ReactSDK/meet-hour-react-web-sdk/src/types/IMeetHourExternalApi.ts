...
export default interface IMeetHourExternalApi extends EventEmitter {
    ...
    /**
     * Adds multiple event listeners to the Meet Hour External API.
    ...
    /**
     * Removes the listeners and removes the Meet Hour frame.
     *
     */
    dispose: () => void;
    ...
    /**
     * Returns the IFrame that loads the Meet Hour External API.
     */
