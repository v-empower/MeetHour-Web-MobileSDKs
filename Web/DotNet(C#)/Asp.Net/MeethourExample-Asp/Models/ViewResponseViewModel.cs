...
public class ViewResponseViewModel {
  ...
  public class LivestreamSettings {
    ...
    public FacebookStreamKey FacebookStreamKey { get; set; }
    public YouTubeStreamKey YouTubeStreamKey { get; set; }
  }
  ...
  public class Settings {
    ...
    public int JoinAnytime { get; set; }
    public int EnableLobby { get; set; }
    public int EnableRecording { get; set; }
    public int EnableLivestream { get; set; }
    public int EnableEmbeedMeeting { get; set; }
    public int DonorBox { get; set; }
  }
  public class Meeting {
    ...
    public object WeeklyDays { get; set; }
    public object MonthlyDay { get; set; }
    public object MonthlyWeek { get; set; }
    public object MonthlyWeekDay { get; set; }
    public object EndTimes { get; set; }
    ...
    public object MeetingTopic { get; set; }
    public object MeetingAgenda { get; set; }
    public object MeetingImage { get; set; }
    public List<Host> Hosts { get; set; }
    public int AllowJoinBefore { get; set; }
    public int NoOfInvitees { get; set; }
    public int EnableLobby { get; set; }
    public string IcsId { get; set; }
    public int IsShowPortal { get; set; }
    public int IsClientAppMeeting { get; set; }
