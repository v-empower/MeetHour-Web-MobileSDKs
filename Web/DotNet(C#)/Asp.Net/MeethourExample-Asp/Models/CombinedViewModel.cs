namespace MeethourExample_Asp.Models
{
    public class CombinedViewModel
    {
        ...
        public MeetingResponseViewModel? MeetingModel { get; set; }
        public ContactResponseViewModel? contactModel { get; set; }
        public TimezoneResponseViewModel? timeZoneModel { get; set; }
        public JoinMeetingResponseViewModel? JoinMeetingModel { get; set; }
