                ...
                <div class="w-full max-w-sm space-y-8">
                    <div>
                      ...
                      focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Meeting Name"></div>
                                <div><label for="passcode" class="sr-only">Pass code</label><input required id="passcode" name="passcode" type="text"  class="appearance-none rounded-none relative block
                      w-full px-3 py-2 border border-gray-300
                      ...
                      focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Meeting Time"></div>
                                <h2 style="margin-top: 15px;">Time zone</h2><div class='w-full h-10 rounded-md'>
                                        ...
                                        <select name="mySelectParticipants"  id="mySelectParticipants"
                                           ...
                                           <option key="0" class="w-96" value="">Select Participants</option> 
					                         ...
					                         for (int i = 0; i < contactsArray.length(); i++) {
											     ...
											     String first_name = contactObject.getString("first_name");
	...
	%>
	 ...
	 //schedule meeting manually
        $(document).ready(function() {
            setTimeout(() => {
                getContactsList(  <%= contactResponse %>);
            }, 500)
