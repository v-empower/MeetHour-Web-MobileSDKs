## 4.0.0
* Update Meet Hour SDK for Android to 3.3.0.
* Update Meet Hour SDK for iOS to 3.3.0.
...
## 2.1.0
* Update Meet Hour SDK for Android to 3.2.0.
* Fixes issue with Android crashing when calling MeetHour.closeMeeting().
...
* Update Meet Hour SDK to 2.11.0.
* Update iOS deployment target to 11.0.

## 1.0.0
* Update Meet Hour SDK for Android to 2.10.0.
* Update Meet Hour SDK for iOS to 2.10.2.
...
## 0.2.1
* Updated MeetHour SDK to v2.9.0 
...
* Upgrading to IOS Cocoapods MeetHour v2.8.1
